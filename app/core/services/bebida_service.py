"""Registro de bebidas — thin wrapper sobre el motor común.

Solo admite recetas de categoría Bebidas y productos sueltos con
`Producto.es_bebida == True`.
"""
...
servicio = crear_servicio(
    ...
    # Distinto del export de historial de compras de bebidas (tipo="bebidas").
...
CATEGORIAS_RECETA = [CategoriaReceta.BEBIDAS]
PASO_CANTIDAD = 0.5
