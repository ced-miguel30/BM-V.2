...
def _datos() -> AppData:
    return AppData(
        ...
        recetas=[
            Receta("r_cen", "Merluza", [IngredienteReceta("p01", 0.25)], CategoriaReceta.CENA),
            Receta("r_beb", "Copa vino", [IngredienteReceta("p02", 0.15)], CategoriaReceta.BEBIDAS),
            Receta("r_des", "Tostada", [IngredienteReceta("p03", 0.1)], CategoriaReceta.DESAYUNO),
