...
def _datos_stock() -> AppData:
    return AppData(
        ...
        recetas=[
            Receta("r01", "Tostada", [IngredienteReceta("p01", 0.1)], CategoriaReceta.DESAYUNO),
            Receta("r02", "Pasta", [IngredienteReceta("p01", 0.2)], CategoriaReceta.COMIDA),
            Receta("r03", "Café latte", [IngredienteReceta("p02", 0.2)], CategoriaReceta.BEBIDAS),
            Receta("r04", "Sopa", [IngredienteReceta("p01", 0.15)], CategoriaReceta.CENA),
        ],
